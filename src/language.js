...
const i18nStrings = {
  en: {
    ...
    youTubeSubtitlesHint: "Turn on CC in the video. The whole caption file is read, merged into complete sentences and translated ahead of time, then shown one sentence at a time. If the file can't be read, the captions on screen are translated instead. Uses the page translation source.",
    youTubePanel: "Transcript side panel",
    youTubePanelHint: "Lists the whole video's captions with translations next to the player. Click a line to jump there; select a word to look it up.",
    youTubeModeBilingual: "Bilingual",
    youTubeModeTranslation: "Translation",
    youTubeModeOriginal: "Original",
    youTubeModeNone: "Hidden",
    youTubeOnVideo: "On-video subtitles",
    youTubeOnVideoHint: "Choose \"Hidden\" to keep the video clean and read the transcript side panel instead. Keep CC on in the video — that is when YouTube downloads the captions.",
    youTubeSize: "Subtitle size",
    youTubeSizeHint: "Relative to the caption size set in YouTube's own subtitle options.",
    youTubePosition: "Subtitle position",
    youTubePositionHint: "Drag the subtitles on the video to move them. Double-click them to put them back where CC is.",
    resetPosition: "Reset",
    glossary: "Glossary",
  ...
  zh: {
    ...
    youTubeSubtitlesHint: "影片要開啟 CC 字幕。會讀取整份字幕檔，合成完整的句子先翻好，播放時一次顯示一整句；讀不到字幕檔時改翻畫面上的 CC。使用整頁翻譯的翻譯來源。",
    youTubePanel: "字幕側欄",
    youTubePanelHint: "在影片右邊列出整部影片的原文和譯文，點一句就跳到那裡；選取文字可以查單字。",
    youTubeModeBilingual: "雙語",
    youTubeModeTranslation: "只譯文",
    youTubeModeOriginal: "只原文",
    youTubeModeNone: "不顯示",
    youTubeOnVideoHint: "選「不顯示」可以讓影片畫面保持乾淨，只看旁邊的字幕側欄。影片的 CC 還是要開著，YouTube 才會下載字幕。",
    youTubeOnVideo: "影片上的字幕",
    youTubeSize: "字幕大小",
    youTubeSizeHint: "以 YouTube 字幕設定裡的大小為準，再放大或縮小。",
    youTubePosition: "字幕位置",
    youTubePositionHint: "在影片上直接拖曳字幕就能移動；按兩下字幕回到原本 CC 的位置。",
    resetPosition: "回到原本位置",
    glossary: "術語表",
    vocabulary: "生字本",
    sites: "網站清單",
